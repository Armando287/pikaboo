// based on Cassie's https://codepen.io/svganimationworkshop/pen/oNLLLzJ
...
tl.to('#pikabooMain', { yPercent: -30 })
  ...
  .to('#lamp-light', { duration: 0.8, opacity: 0.2, duration: 1, repeat: -1, repeatDelay:8, ease: "rough({ template: none.out, strength: 1, points: 20, taper: 'none', randomize: true, clamp:  false})" }, '<');
